...
def main(page: Page):
    ...
    e = TextField(label = "Email", prefix_icon = icons.EMAIL)
    s = TextField(label = "Senha", prefix_icon = icons.PASSWORD, can_reveal_password = True, password = True)
    m = TextField(label = "Nome", prefix_icon = icons.PEOPLE_ALT)
    ...
    t6 = Text("Criar uma conta",height=100, size= 30,weight= FontWeight.W_900,color="#000000")
    ...
    button1 = FilledButton(text = "Cadastrar", on_click = lambda e: entrar(e))
    button2 = FilledButton(text = "Voltar", on_click = lambda e: voltar(e))
    button3 = FilledButton(text = "Increver-se", on_click = lambda e: voltar(e))
    button4 = FilledButton(text = "Entrar", on_click = lambda e: voltar(e))

    cadastro = Row([

        Container(height = 470, width = 365, bgcolor = "#ffffff", padding=30,
        ...
        Container(height = 490, width = 365, bgcolor = "#557dff", padding=30,
                  content = Column([t6,t7,m,e,s,button3
    ...
    lg = Row([
         ...
         Container(height = 470, width = 385, bgcolor = "#557dff", padding=30,
                  
                  content = Column([t,t3,e,s,t4,button4
                                    ],alignment=MainAxisAlignment.CENTER, horizontal_alignment=CrossAxisAlignment.CENTER)
                  ),
